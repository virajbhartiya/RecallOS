      ...
      <Section className="bg-transparent py-8 sm:py-12 md:py-16 lg:py-20 xl:py-24">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-8 sm:mb-12 md:mb-16">
            <div className="inline-flex items-center gap-2 rounded-full border border-gray-300/60 bg-white/70 px-2.5 sm:px-3 py-0.5 sm:py-1 text-[10px] sm:text-[11px] tracking-[0.2em] uppercase text-gray-600 mb-3 sm:mb-4">
              Flow
          ...
          <div className="relative mt-8 sm:mt-12 md:mt-16 overflow-hidden rounded-[32px]">
            <div className="absolute inset-x-2 sm:inset-x-4 md:inset-x-10 -top-6 sm:-top-10 bottom-4 sm:bottom-6 bg-gradient-to-b from-white/80 via-white/30 to-transparent rounded-[32px] sm:rounded-[40px] blur-3xl pointer-events-none" />
            <div
            ...
            <div className="relative grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-10 z-10">
              {flowMoments.map((moment, index) => (
                ...
                >
                  ...
                  />
                  <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/80 px-2.5 sm:px-3 py-1 text-[10px] sm:text-[11px] uppercase tracking-[0.2em] text-gray-500 mb-2 sm:mb-3">
