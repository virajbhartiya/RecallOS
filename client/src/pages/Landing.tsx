          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <ConsoleButton
                ...
                onClick={() => window.open('https://github.com/virajbhartiya/RecallOS/releases/latest', '_blank')}
              >
                <span className="relative z-10 text-sm font-medium">Try for Free</span>
      ...
      <Section className="min-h-screen bg-transparent relative overflow-hidden py-16 sm:py-20 lg:py-28">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div 
            ...
            style={{
              animation: 'float 8s ease-in-out infinite reverse, pulse-glow 3s ease-in-out infinite 1s'
            }}
          />
          <div 
            className="absolute bottom-40 left-1/4 w-4 h-4 bg-gradient-to-r from-gray-200 to-gray-300 rounded-full"
            style={{
              animation: 'float 5s ease-in-out infinite 0.5s, pulse-glow 2s ease-in-out infinite 2s'
            }}
          />
          <div 
            className="absolute top-1/2 right-1/3 w-3 h-12 border-l-2 border-gray-300/60"
            style={{
              animation: 'float 7s ease-in-out infinite 1s, pulse-glow 3s ease-in-out infinite 0.5s'
            }}
          />
          <div 
            className="absolute top-1/3 left-1/3 w-5 h-5 border-2 border-gray-300/40 rounded-full"
            style={{
              animation: 'float 9s ease-in-out infinite 2s, pulse-glow 4s ease-in-out infinite 1.5s'
            }}
          />
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 h-full flex items-center">
          <div className="w-full text-center space-y-8 sm:space-y-10 mx-auto">
            ...
            <div 
              ...
              style={{
                animation: isVisible ? 'fadeInScale 0.8s ease-out 0.1s both' : 'none'
              }}
            >
              <div className="inline-flex items-center gap-2 rounded-full border border-gray-300/80 bg-white/80 backdrop-blur px-3 py-1 text-xs sm:text-sm text-gray-700">
                <span className="inline-flex items-center rounded-full bg-black text-white px-2 py-0.5 text-[10px] sm:text-xs uppercase tracking-wider">New</span>
                <span className="whitespace-nowrap">Instant search for anything you saw online</span>
                <button 
            ...
            <div 
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-5xl mx-auto">
                {[
                  { title: 'Automatic capture', desc: 'Key text, links and context saved while you browse.' },
                  { title: 'Search like you remember', desc: 'Type a few words to jump to the exact page and section.' },
                  { title: 'Private by default', desc: 'Everything stays on your device unless you choose to sync.' }
                ].map((feat, i) => (
                  <div
                    key={i}
                  ...
                  >
                    <div className="space-y-1">
                      <div className="text-sm font-semibold text-gray-900 tracking-tight">{feat.title}</div>
                      <div className="text-sm text-gray-600 leading-snug">{feat.desc}</div>
                    </div>
                  </div>
                ))}
              </div>
