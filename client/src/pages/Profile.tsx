          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-gray-200 p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {Array.isArray(
                  ...
                  profile.static_profile.json.personality_traits.length > 0 && (
                    <div>
                      <div className="text-xs font-mono text-gray-500 mb-2 uppercase tracking-wide">
                        [PERSONALITY TRAITS]
                      </div>
                ...
                {profile.static_profile.json.learning_preferences &&
                  Object.keys(profile.static_profile.json.learning_preferences)
                    .length > 0 && (
                    <div>
                      <div className="text-xs font-mono text-gray-500 mb-2 uppercase tracking-wide">
            ...
            <div className="bg-white border border-gray-200 p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                {Array.isArray(profile.dynamic_profile.json.current_projects) &&
                ...
                {Array.isArray(profile.dynamic_profile.json.current_context) &&
                ...
                {Array.isArray(profile.dynamic_profile.json.upcoming_events) &&
